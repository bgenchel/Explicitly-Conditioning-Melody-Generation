...
net = ChordandInterConditionedLSTM(input_dict_size=DUR_DIM, 
                                   cond_dict_size=PITCH_DIM,
                                   chord_dim=chord_dim,
                                   embedding_dim=args.dur_embedding_dim,
                                   cond_embedding_dim=args.pitch_embedding_dim,
...
net, interrupted, train_losses, valid_losses = training.train_and_inter_conditioned_net(
    ...
    batched_train_pitch_seqs, batched_train_dur_seqs, batched_train_dur_targets, 
    batched_valid_chord_seqs, batched_valid_pitch_seqs, batched_valid_dur_seqs, 
