...
try:
    ...
    for epoch in range(args.epochs):
        ...
        writer.write_loss({'training': train_loss, 'validation': valid_loss}, epoch_label)
...
help.save_run(dirpath, info_dict, train_losses, valid_losses, model_inputs, model, args.keep)
