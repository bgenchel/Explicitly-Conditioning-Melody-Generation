...
net = DurationLSTM(args.dur_input_dict_size, args.pitch_input_dict_size, harmony_dim,
    args.dur_embedding_dim, args.pitch_embedding_dim, args.hidden_dim,
...
net, interrupted, train_losses, valid_losses = train_harmony_plus_conditioned_net(
    ...
    batched_valid_pitch_seqs, batched_valid_dur_seqs, batched_valid_dur_targets, 
    writer, args.print_every)
...
if args.keep:
    ...
    model_inputs = {'dur_input_dict_size': args.dur_input_dict_size, 
                    'pitch_input_dict_size': args.pitch_input_dict_size,
